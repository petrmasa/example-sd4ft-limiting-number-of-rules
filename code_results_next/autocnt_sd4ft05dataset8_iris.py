...
original=pd.read_csv("w:\\development\\cleverminer\\_data\\Iris.csv")#, sep='\t')
...
while not(req_stop):
    ...
    clm = cleverminer(df=df, proc='SD4ftMiner',
                      ...
                      ante={
                          'attributes': [
                              {'name': 'PetalLengthCm', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SepalWidthCm', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SepalLengthCm', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                          ], 'minlen': 1, 'maxlen': 2, 'type': 'con'},
                      succ={
                          'attributes': [
                              {'name': 'Species', 'type': 'rcut', 'minlen': 1, 'maxlen': 1},
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'},
                      frst={
                          'attributes': [
                              {'name': 'PetalWidthCm', 'type': 'subset', 'minlen': 1, 'maxlen': 1}
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'},
                      scnd={
                          'attributes': [
                              {'name': 'PetalWidthCm', 'type': 'subset', 'minlen': 1, 'maxlen': 1}
