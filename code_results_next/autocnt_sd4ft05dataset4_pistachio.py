...
original=pd.read_csv("w:\\development\\cleverminer\\_data\\pistachio.csv")
...
while not(req_stop):
    ...
    clm = cleverminer(df=df, proc='SD4ftMiner',
                      ...
                      ante={
                          'attributes': [
                              {'name': 'AREA', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'PERIMETER', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'MAJOR_AXIS', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'MINOR_AXIS', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'EQDIASQ', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SOLIDITY', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'CONVEX_AREA', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'EXTENT', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'ASPECT_RATIO', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'ROUNDNESS', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'COMPACTNESS', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SHAPEFACTOR_1', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SHAPEFACTOR_2', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SHAPEFACTOR_3', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SHAPEFACTOR_4', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                          ], 'minlen': 1, 'maxlen': 2, 'type': 'con'},
                      succ={
                          'attributes': [
                              {'name': 'Class', 'type': 'subset', 'minlen': 1, 'maxlen': 1},
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'},
                      frst={
                          'attributes': [
                              {'name': 'ECCENTRICITY', 'type': 'lcut', 'minlen': 1, 'maxlen': 4}
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'},
                      scnd={
                          'attributes': [
                              {'name': 'ECCENTRICITY', 'type': 'rcut', 'minlen': 1, 'maxlen': 4}
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'}
                      )
