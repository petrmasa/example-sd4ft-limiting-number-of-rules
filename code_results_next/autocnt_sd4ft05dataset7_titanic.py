...
original=pd.read_csv("w:\\development\\cleverminer\\_data\\SVMtrain.csv")#, sep='\t')
    ...
    clm = cleverminer(df=df, proc='SD4ftMiner',
                      ...
                      ante={
                          'attributes': [
                              ...
                              {'name': 'Age', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'SibSp', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'Parch', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'Fare', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                              {'name': 'Embarked', 'type': 'seq', 'minlen': 1, 'maxlen': 3},
                      ...
                      frst={
                          'attributes': [
                              {'name': 'Pclass', 'type': 'subset', 'minlen': 1, 'maxlen': 1}
                          ], 'minlen': 1, 'maxlen': 1, 'type': 'con'},
                      scnd={
                          'attributes': [
                              {'name': 'Pclass', 'type': 'subset', 'minlen': 1, 'maxlen': 1}
